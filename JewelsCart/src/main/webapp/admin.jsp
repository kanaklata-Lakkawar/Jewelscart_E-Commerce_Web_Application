...
%>
      ...
      <% 
String message5 = (String) request.getAttribute("message");
if (message5 != null) {
%>
   <br><div class='alert alert-success' role='alert'><%=message5 %></div>
<%}%>
 <!-- shop section -->
          ...
          <div class="box">
            <a href="item.jsp?pId=<%=p.getPid()%>">
              ...
              <div class="action-buttons">
                <!-- Edit button -->
                <a href="editproduct.jsp?pid=<%=p.getPid()%>" class="btn btn-primary btn-custom">Edit</a>
<!-- Delete button -->
<a href="deleteserv?pid=<%=p.getPid()%>" class="btn btn-danger btn-custom">Delete</a>
              </div>
              <div class="new">
                <span>
                  New
